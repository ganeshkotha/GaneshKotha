/*Program Name    : program to demonstrate the constructor/destructor/operator overloading and member functions using integer pointer and character array as private variables*/
/*filename	      : Case6.cpp
  Name   	      : Kotha Ganesh
  Date   	      : 11/04/2020 */
#include<iostream>
...
int main(int argc,char *argv[])
{
    ...
    {
        student obj("  Ganesh");			//calling parameterized constructor
        student obj1("	Kotha");
        student obj2;
